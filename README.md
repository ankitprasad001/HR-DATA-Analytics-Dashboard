...
**This project showcases the employee attendance data of AtliQ Technologies and builds a Data Analytics Dashboard using Power BI to automate the working of HR.** <br>
...
*	WFH % by Date
*	SL % by Date
![Employee Attendence Dashboard HR](https://github.com/ankitprasad001/HR-DATA-Analytics-Dashboard/blob/main/Dashboard%20Images/1.jpg?raw=true)
